  ...
  <nav class="navbar">
    <div class="container mx-auto px-6 md:px-3">
      ...
      <div class="flex-none">
        ...
        <!--Hamburger-->
        <button  @click="open = ! open" aria-label="Toggle menu button" class="lg:hidden btn btn-square btn-ghost hover:bg-gray-100 hover:text-gray-500 drawer-button" for="my-drawer">
