    ...
    <form>
        ...
        <div class="p-4">
            ...
            <div class="form-control mb-4">
                <div class="col-span-6 sm:col-span-4 flex items-start">
                  <div class="flex items-center h-5">
                    <input id="has_git" name="has_git" type="checkbox" class="checkbox checkbox-sm toggle_block">
                  </div>
            ...
            <div class="form-control mb-4">
                <div class="col-span-6 sm:col-span-4 flex items-start">
                  <div class="flex items-center h-5">
                    <input id="has_web" name="has_web" type="checkbox" class="checkbox checkbox-sm toggle_block">
                  </div>
                  <div class="ml-3 text-sm">
