          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex mb-4">
              <span class="flex items-center">
                <span class="text-gray-600">{{$project->get_date_created()}}</span>
              </span>
            </div>
            ...
            <div class="flex-1">
              @if(isset($project->git_link))
                <a target="_blank" href="{{$project->git_link}}" class="text-white bg-blue-500 hover:bg-blue-600 font-bold py-2 px-4 rounded inline-flex items-center mb-4 mr-3">
              ...
              @if(isset($project->web_link))
                <a target="_blank" href="{{$project->web_link}}" class="text-white bg-blue-500 hover:bg-blue-600 font-bold py-2 px-4 rounded inline-flex items-center mb-4">
